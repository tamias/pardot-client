...
var Visitors = /** @class */ (function (_super) {
    __extends(Visitors, _super);
    function Visitors() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.objectName = 'visitor';
        return _this;
    }
    Visitors.prototype.query = function (params) {
    ...
    Visitors.prototype.read = function (id, params) {
        return __awaiter(this, void 0, void 0, function () {
            var url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Visitors.prototype.assign = function (id, params) {
        return __awaiter(this, void 0, void 0, function () {
            var url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
