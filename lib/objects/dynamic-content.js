...
var DynamicContent = /** @class */ (function (_super) {
    __extends(DynamicContent, _super);
    function DynamicContent() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.objectName = 'dynamicContent';
        return _this;
    }
    DynamicContent.prototype.query = function (params) {
    ...
    DynamicContent.prototype.read = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
