...
var EmailTemplates = /** @class */ (function (_super) {
    ...
    function EmailTemplates() {
        ...
        _this.objectName = 'emailTemplate';
        return _this;
    }
    EmailTemplates.prototype.read = function (id, params) {
    ...
    EmailTemplates.prototype.listOneToOne = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.parent.getApiUrl(this.objectName, ['listOneToOne']);
                        return [4 /*yield*/, this.parent.axios.get(url, { params: params })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
