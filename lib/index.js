            ...
            if (!this.axiosInstance) {
                ...
                this.axiosInstance.interceptors.request.use(function (config) {
                    ...
                    if (data && typeof data === 'object') {
                        ...
                        var convertedData = Object.entries(data).reduce(function (acc, _a) {
                            var _b;
                            var key = _a[0], value = _a[1];
                            return (__assign(__assign({}, acc), (_b = {}, _b[key] = typeof value === 'boolean' ? +value : value, _b)));
                        }, {});
                        data = qs_1.stringify(convertedData);
                    }
