...
var PardotClient = /** @class */ (function () {
    ...
    PardotClient.prototype.convertRequestValues = function (data, isQueryRequest) {
        ...
        get: function () {
            ...
            if (!this.axiosInstance) {
                ...
                this.axiosInstance.interceptors.request.use(function (config) {
                    ...
                    var isQueryRequest = /\/query/.test(url);
                    if (data && typeof data === 'object') {
                        data = qs_1.stringify(_this.convertRequestValues(data, isQueryRequest));
                    }
                    if (params && typeof params === 'object') {
                        params = _this.convertRequestValues(params, isQueryRequest);
                    }
                ...
                axios_auth_refresh_1.default(this.axiosInstance, function (failedRequest) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                newToken = _b.sent();
                                this.token = this.oauthClient.createToken(__assign({ refresh_token: this.token.token.refresh_token }, newToken.token));
