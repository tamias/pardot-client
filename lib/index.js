...
var Pardot = /** @class */ (function () {
    ...
    Object.defineProperty(Pardot.prototype, "axios", {
        get: function () {
            var _this = this;
            if (!this.axiosInstance) {
                ...
                this.axiosInstance.interceptors.request.use(function (config) { return (__assign(__assign({}, config), { headers: __assign({ Authorization: "Bearer " + _this.token.token.access_token, 'Pardot-Business-Unit-Id': _this.businessUnitId }, config.headers), params: __assign({ format: 'json' }, config.params) })); });
            }
